...
public class LambdaReturnValueDemo {
    ...
    public static void main(String[] args) {
        ...
        // Example 1.
        System.out.println("Example 1: Returning a value from a single-line demo.lambda expression.");
        doTest(aPerson, p -> p.getAge() >= 20 && p.getAge() <= 30);

        // Example 2.
        System.out.println("\nExample 2: Returning a value from a multi-line demo.lambda expression.");
        doTest(aPerson, p -> {
            int age = p.getAge();
