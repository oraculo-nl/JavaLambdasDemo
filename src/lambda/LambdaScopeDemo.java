...
public class LambdaScopeDemo {
    ...
    public static void main(String... args) {
        ...
        NestedClass n = obj.new NestedClass();
    ...
    class NestedClass {
        ...
        void methodInNestedClass(int x) {
            ...
            SomeInterface impl = y -> {
                ...
                // We can access our own demo.lambda expression parameters, of course.
                System.out.println("y = " + y);   				
                
                // We can access any demo.methods or variables in enclosing class, via the "this" keyword.
