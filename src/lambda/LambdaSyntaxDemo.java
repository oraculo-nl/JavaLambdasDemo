...
public class LambdaSyntaxDemo {
    ...
    public static void main(String[] args) {
        ...
        // Example 1.
        System.out.println("Example 1: Single-line demo.lambda expression.");
        Command<Person> displayPersonName = p -> System.out.println(p.getName());
        displayPersonName.execute(aPerson);

        // Example 2.
        System.out.println("\nExample 1: Multi-line demo.lambda expression.");
        ...
        // Example 3.
        System.out.println("\nExample 3: Pass a demo.lambda expression into a method.");
